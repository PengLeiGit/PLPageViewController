...
extension UIColor {
    ...
    public static let PLPage_gray  = UIColor.PLHex(hex: "666666")
    public static let PLPage_red  = UIColor.red
    public static let PLPage_line  = UIColor.PLHex(hex: "EEEEEE")
     ...
     * RGB颜色 不用除以255
     */
    public static func PLRGB(r: CGFloat, g: CGFloat, b: CGFloat) -> UIColor {
     ...
     * 如果是6位，默认是不透明。
     */
    public class func PLHex(hex: String, alpha: CGFloat = 1.0) -> UIColor {
...
extension String {
     ...
     * 字符串的截取 从头截取到指定index
     */
    public func PLClipFromPrefix(to index: Int) -> String {
     ...
     * 计算字符串的宽度
     */
    public func PlGetWidth(font: CGFloat, height: CGFloat) -> CGFloat {
        return PLGetWidth(font: UIFont.systemFont(ofSize: font), height: height)
    }
    public func PLGetWidth(font:UIFont,height:CGFloat) -> CGFloat {
