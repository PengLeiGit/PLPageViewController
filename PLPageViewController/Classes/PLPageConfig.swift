...
public class PLPageConfig: NSObject {
     ...
     * 数组个数必须和vcs个数一致
     */
    public var categoryModels: [PLCategoryBarModel] = [PLCategoryBarModel]()
    /**
     * 视图控制器数据源
     * 数组个数必须和titles个数一致
     */
    ...
    public struct CategoryStruct {
        ...
        /// 未选中的字体颜色
        public var normalColor: UIColor = UIColor.PLPage_gray
        /// 选中的字体颜色
        public var selectedColor: UIColor = UIColor.PLPage_red
